...
bool cdr_serialize_moteus_msgs__msg__PositionCommand(
  const moteus_msgs__msg__PositionCommand * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moteus_msgs
bool cdr_deserialize_moteus_msgs__msg__PositionCommand(
  eprosima::fastcdr::Cdr & cdr,
  moteus_msgs__msg__PositionCommand * ros_message)
{
  // Field name: position
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moteus_msgs
bool cdr_serialize_key_moteus_msgs__msg__PositionCommand(
  const moteus_msgs__msg__PositionCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: position
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moteus_msgs
size_t get_serialized_size_key_moteus_msgs__msg__PositionCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PositionCommand__ros_msg_type * ros_message = static_cast<const _PositionCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moteus_msgs
size_t max_serialized_size_key_moteus_msgs__msg__PositionCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moteus_msgs__msg__PositionCommand * ros_message = static_cast<const moteus_msgs__msg__PositionCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moteus_msgs__msg__PositionCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moteus_msgs__msg__PositionCommand * ros_message = static_cast<moteus_msgs__msg__PositionCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moteus_msgs__msg__PositionCommand(cdr, ros_message);
}
