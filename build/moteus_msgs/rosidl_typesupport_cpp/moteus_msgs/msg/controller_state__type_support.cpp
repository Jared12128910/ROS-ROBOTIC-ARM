...
static const _ControllerState_type_support_symbol_names_t _ControllerState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moteus_msgs, msg, ControllerState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, moteus_msgs, msg, ControllerState)),
  }
};
...
{
  return &::moteus_msgs::msg::rosidl_typesupport_cpp::ControllerState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, moteus_msgs, msg, ControllerState)() {
  return get_message_type_support_handle<moteus_msgs::msg::ControllerState>();
}
