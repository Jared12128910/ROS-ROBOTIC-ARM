...
#include "moteus_msgs/msg/detail/controller_state__type_support.h"
...
static const _ControllerState_type_support_symbol_names_t _ControllerState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moteus_msgs, msg, ControllerState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moteus_msgs, msg, ControllerState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moteus_msgs, msg, ControllerState)() {
  return &::moteus_msgs::msg::rosidl_typesupport_c::ControllerState_message_type_support_handle;
}
